...
char *APPID = "318e3336"; //APPID
char *whole_result = " "; //识别到的所有内容

/*************************[2]语法识别资源路径、语法路径、音频文件保存地址等**********************/
//语法相关参数,路径最好设置为绝对地址
char *ASR_RES_PATH = (char*)"fo|/home/padroid/ros2_ws/src/offlineros2demo/configs/common.jet"; //离线语法识别资源路径，重要，与麦克风及appid绑定
char *GRM_FILE = (char*)"/home/padroid/ros2_ws/src/offlineros2demo/configs/call.bnf";					//构建离线识别语法网络所用的语法文件，用户自修改文件
char *GRM_BUILD_PATH = (char*)"/home/padroid/ros2_ws/build/GrmBuilld";   //构建离线语法识别网络生成数据保存路径
